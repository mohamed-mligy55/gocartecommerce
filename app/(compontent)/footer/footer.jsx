        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-12 mb-12 text-left">
          ...
          <div className="lg:col-span-1 space-y-6">
            ...
            <div className="flex gap-4">
              <Link href="#" className="p-2 bg-white/5 rounded-lg hover:bg-[#e85a0e] transition-all hover:-translate-y-1">{icons.facebook}</Link>
              <Link href="#" className="p-2 bg-white/5 rounded-lg hover:bg-[#e85a0e] transition-all hover:-translate-y-1">{icons.instagram}</Link>
              <Link href="#" className="p-2 bg-white/5 rounded-lg hover:bg-[#e85a0e] transition-all hover:-translate-y-1">{icons.twitter}</Link>
            </div>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4 text-gray-400 text-sm">
              <li><Link href="/shop" className="hover:text-[#e85a0e] transition-colors">All Products</Link></li>
              <li><Link href="/featured" className="hover:text-[#e85a0e] transition-colors">Featured Items</Link></li>
              <li><Link href="/new-arrivals" className="hover:text-[#e85a0e] transition-colors">New Arrivals</Link></li>
              <li><Link href="/discounts" className="hover:text-[#e85a0e] transition-colors">Special Offers</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4 text-gray-400 text-sm">
              <li><Link href="/category/gaming" className="hover:text-[#e85a0e] transition-colors">Gaming Gear</Link></li>
              <li><Link href="/category/audio" className="hover:text-[#e85a0e] transition-colors">Audio & Music</Link></li>
              <li><Link href="/category/mobile" className="hover:text-[#e85a0e] transition-colors">Mobile Accessories</Link></li>
              <li><Link href="/category/laptops" className="hover:text-[#e85a0e] transition-colors">Laptops & PCs</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4 text-gray-400 text-sm">
              <li><Link href="/track-order" className="hover:text-[#e85a0e] transition-colors">Track Order</Link></li>
              <li><Link href="/shipping" className="hover:text-[#e85a0e] transition-colors">Shipping Info</Link></li>
              <li><Link href="/returns" className="hover:text-[#e85a0e] transition-colors">Returns & Refunds</Link></li>
              <li><Link href="/contact" className="hover:text-[#e85a0e] transition-colors">Contact Support</Link></li>
            </ul>
          </div>
